...
#define RHONABWY_VERSION 0.9.6
#define RHONABWY_VERSION_STR "0.9.6"

#define RHONABWY_VERSION_MAJOR 0
#define RHONABWY_VERSION_MINOR 9
#define RHONABWY_VERSION_PATCH 6
